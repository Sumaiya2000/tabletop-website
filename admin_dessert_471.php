<?php
	...
	$query1 = "select d.img,p.model,p.price,d.description,p.pid,p.availability from dessert AS d inner join product AS p on d.pid=p.PID";
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 fixed-top">
	  ...
	  <div class="categories">
        ...
        <div class="small-container">
            <div class="row">
				...
				<div class="col-3">
					...
					if (isset($_POST['delete'])){
						$pid=$_POST['pid'];
						$del="DELETE FROM `dessert` WHERE pid='$pid'";
            ...
            <br>
            <center>
                <a href="dessert_insert_471.php" style="color: rgb(100, 100, 100); font-size: 30px;"><b>ADD Desserts</b></a>
            </center>
        </div>
    </div>

<?php
	...
	$query1 = "select sm.img,p.model,p.price,sm.description,p.pid,p.availability from set_menu AS sm inner join product AS p on sm.pid=p.PID";
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="admin_set_menu_471.php" style="color: gray;">Set Menu</a>
                    </li>
                    <li class="nav-item">
	  ...
	  <div class="categories">
        ...
        <div class="small-container">
            <div class="row">
				...
				<div class="col-3">
					...
					if (isset($_POST['delete'])){
						$pid=$_POST['pid'];
						$del="DELETE FROM `set_menu` WHERE pid='$pid'";
            ...
            <br>
            <center>
                <a href="set_menu_insert_471.php" style="color: rgb(100, 100, 100); font-size: 30px;"><b>ADD Set Menu</b></a>
            </center>
        </div>
    </div>

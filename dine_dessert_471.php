<?php
	...
	$query1 = "select a.img,p.model,p.price,a.description,p.pid from dessert AS a inner join product AS p on a.pid=p.PID";
	$data1 = mysqli_query($con, $query1); 
	if(isset($_GET['asc'])){
		$query1 = "select a.img,p.model,p.price,a.description,p.pid from dessert AS a inner join product AS p on a.pid=p.PID order by p.price asc";
	$data1 = mysqli_query($con, $query1); 
	}
	if(isset($_GET['desc'])){
		$query1 = "select a.img,p.model,p.price,a.description,p.pid from dessert AS a inner join product AS p on a.pid=p.PID order by p.price desc";
	$data1 = mysqli_query($con, $query1); 
	}
	?>
...
<body>
 <!-- NAVIGATION -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="dine_dessert_471.php" style="color: gray;">Desserts</a>
                    </li>
                    <li class="nav-item">
	...
	<form method="get">
    <a href="dine_dessert_471.php?asc=<?php echo 'asc';?>" > <span style="padding-left:200px;"></span>Price low to high </a>
	</form>	
	<form method="get">
    <a href="dine_dessert_471.php?desc=<?php echo 'desc';?>" > <span style="padding-left:200px;"></span>Price high to low</a>
	</form>	
	<br><hr><br>

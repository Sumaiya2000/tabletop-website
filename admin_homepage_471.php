 ...
 <!-- NAVIGATION -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link"  href="admin_homepage_471.php" style="color: gray;">Home</a>
                    </li>
                    <li class="nav-item">
      ...
      <div class="typewriter">
		...
		<style type="text/css">
		body{
			background-image: url("image/cus.jpg");
			width: 100%;
			height: 100vh;
        ...
        <div class="pointer-fluid typewriter-text"><p style="text-align:center;"><font color="79FFEC">Welcome to TableTop!</font></p></div>
      </div>

...
session_start();
	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($pid) && !empty($model))
		{
			...
			$query2 = "insert into `drinks` (img,pid,description) values ('$img','$pid','$desc')";
...
<head>
   <meta charset="UTF-8">
    ...
    <title>New Drinks | TableTop</title>
 ...
 <!-- NAVIGATION -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="admin_drinks_471.php" style="color: gray;">Drinks</a>
                    </li>
					<li class="nav-item">
	 ...
	 <form method="post" action="#" class="signup-form">
        ...
        <h1 style="padding-top: 130px">New Drinks</h1>
        <div class="txtb">

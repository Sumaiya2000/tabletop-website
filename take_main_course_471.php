<?php
	...
	$query1 = "select mc.img,p.model,p.price,mc.description,p.pid from main_course AS mc inner join product AS p on mc.pid=p.PID";
	$data1 = mysqli_query($con, $query1); 
	if(isset($_GET['asc'])){
		$query1 = "select mc.img,p.model,p.price,mc.description,p.pid from main_course AS mc inner join product AS p on mc.pid=p.PID order by p.price asc";
	$data1 = mysqli_query($con, $query1); 
	}
	if(isset($_GET['desc'])){
		$query1 = "select mc.img,p.model,p.price,mc.description,p.pid from main_course AS mc inner join product AS p on mc.pid=p.PID order by p.price desc";
	$data1 = mysqli_query($con, $query1); 
	}
	?>
 ...
 <!-- NAVIGATION -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="take_main_course_471.php" style="color: gray;">Main Course</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="categories">
		...
		<h5><span style="padding-left:200px;"></span>Filter by:</h5>
			<form method="get">
    <a href="take_main_course_471.php?asc=<?php echo 'asc';?>" > <span style="padding-left:200px;"></span>Price low to high </a>
	</form>	
	<form method="get">
    <a href="take_main_course_471.php?desc=<?php echo 'desc';?>" > <span style="padding-left:200px;"></span>Price high to low</a>
	</form>	
	<br><hr><br>

...
session_start();
	...
	$name=$_SESSION['name'];	
	$query1="SELECT pid,model,price,subprice,quantity from temp where email='$name'";
        ...
        <div class="small-container cart-page">
			...
			<table>
				...
				<tr>	
					...
					<form method="get">
                    <a href="dine_cart_471.php?quan=<?php echo $result['pid'];?>" class="modbtn"> <center>Change quantity</center> </a>
					</form>
					<?php
					if(isset($_GET['quan'])){
						$pid=$_GET['quan'];	
				...
				?>
					<form method="get">
                    <a href="buy.php?remove=<?php echo $result['pid'];?>&cus=<?php echo 'dine';?>" class="modbtn"> <center>Remove</center> </a>
					</form></td><br>
					</form>
					...
					<td>
                        <div class="cart-info">
                            <div>
                                <br>
                                <p style="text-align: left; font-size: 20px;"><b><?php echo $result[1]; ?> </b></p> <!--  name here -->
            ...
            <div class="total-price">
                <table>
                    ...
                    <tr>
					<form method="get">
                        <td><a href="buy.php?tot=<?php echo $res[0]?>&cus=<?php echo 'dine';?>" class="purbtn"><center>Confirm Purchase</center></a></td>
                    </form>
					</tr>
                </table>
            </div>

<?php
	...
	$query1 = "select a.img,p.model,p.price,a.description,p.pid,p.availability from appetizer AS a inner join product AS p on a.pid=p.PID";
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light py-3 fixed-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="admin_appetizer_471.php" style="color: gray;">Appetizer</a>
                    </li>
                    <li class="nav-item">
	  ...
	  <div class="categories">
        ...
        <div class="small-container">
            <div class="row">
				...
				<div class="col-3">
					...
					if (isset($_POST['delete'])){
						$pid=$_POST['pid'];
						$del="DELETE FROM `appetizer` WHERE pid='$pid'";
            ...
            <br>
            <center>
                <a href="appetizer_insert_471.php" style="color: rgb(100, 100, 100); font-size: 30px;"><b>ADD Appetizer</b></a>
            </center>
        </div>
    </div>

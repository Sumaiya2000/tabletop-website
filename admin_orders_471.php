<?php
	...
	$query1 = "select o.order_no,o.gives,o.total_cost,o.phone from orders o";
	...
	$em=$_SESSION['email'];
	$phone="select phone from customer where email='$em'";
	$phoneq=mysqli_query($con, $phone);
	$phn=mysqli_fetch_array($phoneq);
	?>
	<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ml-auto">
                   ...
                   <li class="nav-item">
					...
					<li class="nav-item">
                       <a class="nav-link"  href="admin_orders_471.php" style="color: gray;">Orders</a>
                    </li>
                   <li class="nav-item">
						            <li class="nav-item">
                        <form method="post">
	...
	<div class="categories">
       ...
       <h2 class="title">All orders</h2>
		...
		if(mysqli_num_rows($data1)>0){
			...
			<td style="text-align: center;"><?php if(!empty($phn)){echo $phn[0];}?></td>
			<td style="text-align: center;">৳ <?php echo $result[2];?></td>
			<td><center>
				<form method="get">
                    <a href="admin_order_details_471.php?dets=<?php echo 'admin';?>&order_no=<?php echo $result[0];?>" class="purbtn"> <center><span style="padding-left:20px;"></span>Details<span style="padding-right:20px;"></span></center> </a>
					</form>
				</center></td>
			...
			<?php
					...
					?>		
				<tr><td><hr style="height:2px;border-width:0;color:gray;background-color:gray"></td>
					<td><hr style="height:2px;border-width:0;color:gray;background-color:gray"></td><td><hr style="height:2px;border-width:0;color:gray;background-color:gray"></td>
					<td><hr style="height:2px;border-width:0;color:gray;background-color:gray"></td></tr>
                <tr>
                    <tr><td></td>
					<td></td>
					
                        <td><b>Total earnings:</b> </td><td><b>৳ <?php echo $totearn[0];?>/- </b></td> 
						</tr>
		...
		if(mysqli_num_rows($data2)>0){
			...
			<td><center>
				<form method="get">
                    <a href="update_stock_471.php?name=<?php echo $result2[0];?>&table=<?php echo 'admin';?>" class="purbtn"><center><span style="padding-left:20px;"></span> Update <span style="padding-right:20px;"></span></center> </a>
					</form>
				</center></td>
		...
		<tr><td><hr style="height:2px;border-width:0;color:gray;background-color:gray"></td>
                ...
                <tr>
					...
					<td></td>
                        ...
                        <td><b>Total expenses:</b> </td><td><b>৳ <?php echo $totcost[0];?>/- </b></td> 
						</tr>
